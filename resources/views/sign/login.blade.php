          ...
          <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card border-0 shadow rounded-3 my-5">
              <div class="card-body p-4 p-sm-5">
                ...
                <form action="/login/au" method="post">
                    @csrf
                  <div class="form-floating mb-3">
                    <input type="name" class="form-control" id="floatingInput" placeholder="name@example.com" name="name" value="{{old('name')}}">
                  ...
                  <p>Belum Memiliki Akun? <a class="reg" href="/register" > Daftar</a> </p>
                </form>
              </div>
            </div>
          </div>
